...
for (let i = 0; i < li_elements.length; i++) {
  li_elements[i].addEventListener("click", function() {
    ...
    if (li_value == "html") {
        ...
        li_value == "css" || li_value == "javascript" || li_value == "react" ||
        
        li_value == "wordpress" || li_value == "mamp" || li_value == "git" ||

        li_value == "vsc" || li_value == "jquery" || li_value == "bootstrap" ||

        li_value == "atom" || li_value == "iterm2" || li_value == "evernote" ||

        li_value == "wappalyzer" || li_value == "whatfont" || li_value == "perfectpixel" ||

        li_value == "stylebot" || li_value == "css3gen" || li_value == "responsive-design" ||

        li_value == "stackoverflow" || li_value == "github" || li_value == "freecodecamp" ||

        li_value == "scrimba" || li_value == "w3school" || li_value == "frontendmentor"
    ) {
        document.querySelector("." + li_value).style.display = "block";
    }
    else {
